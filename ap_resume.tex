...
\section{Tools / Skills}
    {\bf Languages:} Python, C, Bash, C++, Java \\
    {\bf Platforms:} GNU Toolchain, Flex, Bison, GLib, SDL \\
    {\bf Linux Administration:}Puppet, Nagios, Kick server \\
    {\bf Networking Tools:}IPTables, HAProxy, Keepalive \\
    {\bf Hard drive management:}NFS, LVM \\
    {\bf Virtualization:} Xen, Virsh \\
